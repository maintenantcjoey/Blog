...
class __TwigTemplate_4ddaf73752fff48efbf8a9362b0b954028b35db5f63c5ac5f56c04932c83d721 extends Twig_Template
{
    ...
    <a href=\"";
        // line 18
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("blog_show", array("slug" => "javascript-vs-php"));
        echo "\">
    ...
    <a href=\"";
        // line 22
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("blog_show", array("slug" => "javascript-meme"));
        echo "\">
        Testing show() method from BlogController with a real article s slug.
    </a>
    <hr>
    ...
    <a href=\"";
        // line 27
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("blog_show", array("slug" => "rose"));
        echo "\">
        Testing show() method from BlogController with a real article s slug.
    </a>
    <hr>
...
";
    ...
    {
        return array (  168 => 32,  160 => 27,  152 => 22,  145 => 18,  138 => 15,  121 => 12,  113 => 11,  110 => 10,  93 => 9,  90 => 8,  81 => 7,  64 => 5,  46 => 3,  15 => 1,);
    }
...
{% block body %}
    ...
    <hr>
    <a href=\"{{ path('blog_show', { 'slug': \"javascript-meme\" }) }}\">
        Testing show() method from BlogController with a real article s slug.
    </a>
    <hr>

    <a href=\"{{ path('blog_show', { 'slug': \"rose\" }) }}\">
        Testing show() method from BlogController with a real article s slug.
    </a>
    <hr>
...
{% endblock %}", "index.html.twig", "/home/wilder/Bureau/blog/templates/index.html.twig");
    }
}
